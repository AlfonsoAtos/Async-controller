...
public class AsyncService {
	...
	public CompletableFuture<EmployeeNames> getEmployeeName() throws InterruptedException 
	{
		...
		EmployeeNames employeeNameData = restTemplate.getForObject("http://localhost:6000/name", EmployeeNames.class);
	...
	public CompletableFuture<EmployeeAddresses> getEmployeeAddress() throws InterruptedException 
	{
		...
		EmployeeAddresses employeeAddressData = restTemplate.getForObject("http://localhost:6000/address", EmployeeAddresses.class);
	...
	public CompletableFuture<EmployeePhone> getEmployeePhone() throws InterruptedException 
	{
		...
		EmployeePhone employeePhoneData = restTemplate.getForObject("http://localhost:6000/phone", EmployeePhone.class);
